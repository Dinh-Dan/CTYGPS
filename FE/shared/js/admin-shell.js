...
(function (global) {
  ...
  const NAV = [
    ...
    { type: 'item', href: '/admin/warranty.html',  icon: '🛡', label: 'Bảo hành',   key: 'warranty' },
    { type: 'item', href: '/admin/repair.html',    icon: '🔧', label: 'Sửa chữa',   key: 'repair' },
    ...
    { type: 'item', href: '/admin/badges.html',      icon: '🪪', label: 'Phù hiệu xe',  key: 'badges' },
